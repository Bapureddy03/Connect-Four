...
public class main extends Application {
    ...
    private Controller controller;//package name Controller and variable name. field variable
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Pane/*class name */ menuPane = (Pane)/*cast pane*/ rootGridPane.getChildren().get(0);//get first child
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Dipesh Bhatevera");
